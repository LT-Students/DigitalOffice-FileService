...
namespace LT.DigitalOffice.FileService.Business.UnitTests
{
    public class AddNewImageCommandTests
    {
        ...
        public void ShouldAddNewImageAndThumbImmageByController()
        {
            ...
            //_repositoryMock.Verify(r => r.AddNewImage(It.IsAny<DbImage>()), Times.Exactly(1));
            //_mapperMock.Verify(
            //    m => m.Map(
        ...
        //{
        //    _mapperMock
        //         .Setup(x => x.Map(It.IsAny<ImageRequest>(), ImageType.Thumb, It.IsAny<bool>(), It.IsAny<Guid>(), It.IsAny<Guid?>()))
        //         .Throws(new NullReferenceException());
